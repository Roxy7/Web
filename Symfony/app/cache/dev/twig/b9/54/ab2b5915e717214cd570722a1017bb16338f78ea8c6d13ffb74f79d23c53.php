...
class __TwigTemplate_b954ab2b5915e717214cd570722a1017bb16338f78ea8c6d13ffb74f79d23c53 extends Twig_Template {
	...
	protected function doDisplay(array $context, array $blocks = array()) {
		// line 3
		$context ["__internal_44526c40af3473f7c1a7f1ca4fc2ad60ee76713d226ccded0c0e788923240aa5"] = $this;
    ...
    <table>
		...
		foreach ( $context ['_seq'] as $context ["_key"] => $context ["listener"] ) {
			...
			echo "</code></td>
                <td><code>";
			// line 34
			echo $context ["__internal_44526c40af3473f7c1a7f1ca4fc2ad60ee76713d226ccded0c0e788923240aa5"]->getdisplay_listener ( (isset ( $context ["listener"] ) ? $context ["listener"] : $this->getContext ( $context, "listener" )) );
			echo "</code></td>
            </tr>
        ";
		}
		...
		if ($this->getAttribute ( (isset ( $context ["collector"] ) ? $context ["collector"] : $this->getContext ( $context, "collector" )), "notcalledlisteners" )) {
			...
			foreach ( $context ['_seq'] as $context ["_key"] => $context ["listener"] ) {
				...
				echo "</code></td>
                    <td><code>";
				// line 51
				echo $context ["__internal_44526c40af3473f7c1a7f1ca4fc2ad60ee76713d226ccded0c0e788923240aa5"]->getdisplay_listener ( $this->getAttribute ( (isset ( $context ["listeners"] ) ? $context ["listeners"] : $this->getContext ( $context, "listeners" )), (isset ( $context ["listener"] ) ? $context ["listener"] : $this->getContext ( $context, "listener" )), array (), "array" ) );
				echo "</code></td>
                </tr>
            ";
			}
