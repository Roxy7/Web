...
class __TwigTemplate_12ed2a164369464b16550be5e02b6eb5eaea8835a95a2d5f8f4c5d1044712dc5 extends Twig_Template {
    ...
    <ol class=\"traces list-exception\" id=\"traces-";
		...
		foreach ( $context ['_seq'] as $context ["i"] => $context ["trace"] ) {
			...
			echo "            <li>
                ";
			// line 21
			$this->env->loadTemplate ( "TwigBundle:Exception:trace.html.twig" )->display ( array (
					"prefix" => (isset ( $context ["position"] ) ? $context ["position"] : $this->getContext ( $context, "position" )),
					"i" => (isset ( $context ["i"] ) ? $context ["i"] : $this->getContext ( $context, "i" )),
					"trace" => (isset ( $context ["trace"] ) ? $context ["trace"] : $this->getContext ( $context, "trace" )) 
			) );
			// line 22
			echo "            </li>
        ";
