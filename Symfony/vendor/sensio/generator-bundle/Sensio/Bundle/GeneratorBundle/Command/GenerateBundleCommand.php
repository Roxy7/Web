...
class GenerateBundleCommand extends GeneratorCommand {
	...
	protected function configure() {
		...
		) )->setDescription ( 'Generates a bundle' )->setHelp ( <<<EOT
...
EOT
	...
	protected function interact(InputInterface $input, OutputInterface $output) {
		...
		if (null === $namespace) {
			...
			$namespace = $dialog->askAndValidate ( $output, $dialog->getQuestion ( 'Bundle namespace', $input->getOption ( 'namespace' ) ), array (
					'Sensio\Bundle\GeneratorBundle\Command\Validators',
					'validateBundleNamespace' 
		...
		if (null === $bundle) {
			...
			$bundle = $dialog->askAndValidate ( $output, $dialog->getQuestion ( 'Bundle name', $bundle ), array (
					'Sensio\Bundle\GeneratorBundle\Command\Validators',
					'validateBundleName' 
			), false, $bundle );
