...
class GenerateControllerCommand extends GeneratorCommand {
	...
	public function configure() {
		...
		) )->setDescription ( 'Generates a controller' )->setHelp ( <<<EOT
...
EOT
	...
	public function interact(InputInterface $input, OutputInterface $output) {
		...
		while ( true ) {
			$controller = $dialog->askAndValidate ( $output, $dialog->getQuestion ( 'Controller name', $input->getOption ( 'controller' ) ), array (
					'Sensio\Bundle\GeneratorBundle\Command\Validators',
					'validateControllerName' 
			), false, $input->getOption ( 'controller' ) );
		...
		$routeFormat = $dialog->askAndValidate ( $output, $dialog->getQuestion ( 'Routing format (php, xml, yml, annotation)', $defaultFormat ), array (
				'Sensio\Bundle\GeneratorBundle\Command\Validators',
				'validateFormat' 
		), false, $defaultFormat );
