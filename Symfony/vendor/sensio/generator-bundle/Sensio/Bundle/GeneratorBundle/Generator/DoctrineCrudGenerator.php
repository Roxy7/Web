...
class DoctrineCrudGenerator extends Generator {
	 ...
	 *        	A bundle object
	 * @param string $entity
	 *        	The entity relative class name
	 * @param ClassMetadataInfo $metadata
	 *        	The entity class metadata
	 * @param string $format
	 *        	The configuration format (xml, yaml, annotation)
	 * @param string $routePrefix
	 *        	The route name prefix
	 * @param array $needWriteActions
	 *        	Wether or not to generate write actions
	 *        	
	...
	public function generate(BundleInterface $bundle, $entity, ClassMetadataInfo $metadata, $format, $routePrefix, $needWriteActions, $forceOverwrite) {
		...
		$this->actions = $needWriteActions ? array (
				'index',
				'show',
				'new',
				'edit',
	...
	protected function generateConfiguration() {
		...
		$target = sprintf ( '%s/Resources/config/routing/%s.%s', $this->bundle->getPath (), strtolower ( str_replace ( '\\', '_', $this->entity ) ), $this->format );
	...
	protected function generateControllerClass($forceOverwrite) {
		...
		$target = sprintf ( '%s/Controller/%s/%sController.php', $dir, str_replace ( '\\', '/', $entityNamespace ), $entityClass );
	 ...
	 *
	 * @param string $dir
	 *        	The path to the folder that hosts templates in the bundle
	 */
