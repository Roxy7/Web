...
class ClearMetadataCacheDoctrineCommand extends MetadataCommand {
	...
	protected function configure() {
		...
		$this->setName ( 'doctrine:cache:clear-metadata' )->setDescription ( 'Clears all metadata cache for an entity manager' )->addOption ( 'em', null, InputOption::VALUE_OPTIONAL, 'The entity manager to use for this command' )->setHelp ( <<<EOT
