...
class InfoDoctrineCommand extends InfoCommand {
	...
	protected function configure() {
		$this->setName ( 'doctrine:mapping:info' )->addOption ( 'em', null, InputOption::VALUE_OPTIONAL, 'The entity manager to use for this command' )->setDescription ( 'Shows basic information about all mapped entities' )->setHelp ( <<<EOT
